...
app.controller('ctrl', function ($scope, $http) {
    ...
    $scope.add = function (){
        ...
        $http.post("/admin/nhan-vien",$scope.nhanVienAdd).then(r => {
            ...
            document.getElementById("gioiTinhAddER").innerText = e.data.gioiTinh == undefined ? "" : e.data.gioiTinh;
            document.getElementById("ngaySinhAddER").innerText = e.data.ngaySinh == undefined ? "" : e.data.ngaySinh;
